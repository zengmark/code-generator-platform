package com.codegen.web.service.impl;

import cn.hutool.core.collection.CollUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.codegen.web.common.ErrorCode;
import com.codegen.web.constant.CommonConstant;
import com.codegen.web.exception.BusinessException;
import com.codegen.web.exception.ThrowUtils;
import com.codegen.web.mapper.GeneratorMapper;
import com.codegen.web.model.dto.generator.GeneratorQueryRequest;
import com.codegen.web.model.entity.Generator;
import com.codegen.web.model.entity.User;
import com.codegen.web.model.vo.GeneratorVO;
import com.codegen.web.model.vo.UserVO;
import com.codegen.web.service.GeneratorService;
import com.codegen.web.service.UserService;
import com.codegen.web.utils.SqlUtils;
...
public class GeneratorServiceImpl extends ServiceImpl<GeneratorMapper, Generator> implements GeneratorService {
    ...
    public void validGenerator(Generator generator, boolean add) {
        ...
        String projectName = generator.getProjectName();
        String description = generator.getDescription();

        // 创建时，参数不能为空
        if (add) {
            ThrowUtils.throwIf(StringUtils.isAnyBlank(projectName, description), ErrorCode.PARAMS_ERROR);
        }
        // 有参数则校验
        if (StringUtils.isNotBlank(projectName) && projectName.length() > 80) {
    ...
    public QueryWrapper<Generator> getQueryWrapper(GeneratorQueryRequest generatorQueryRequest) {
        ...
        String projectName = generatorQueryRequest.getProjectName();
        ...
        Integer projectStatus = generatorQueryRequest.getProjectStatus();
        String sortField = generatorQueryRequest.getSortField();
        String sortOrder = generatorQueryRequest.getSortOrder();

        // 拼接查询条件
        if (StringUtils.isNotBlank(searchText)) {
            queryWrapper.and(qw -> qw.like("projectName", searchText).or().like("description", searchText));
        }
        ...
        queryWrapper.eq(ObjectUtils.isNotEmpty(projectStatus), "projectStatus", projectStatus);
