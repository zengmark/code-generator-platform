...
import com.codegen.maker.template.enums.FileFilterRangeEnum;
import com.codegen.maker.template.enums.FileFilterRuleEnum;
import com.codegen.maker.template.model.FileFilterConfig;
import com.codegen.maker.template.model.TemplateMakerConfig;
...
public class TemplateMaker {
    ...
    public static long makeTemplate(Meta newMeta, String originProjectPath, TemplateMakerFileConfig templateMakerFileConfig, TemplateMakerModelConfig templateMakerModelConfig, Long id) {
        ...
        // 复制目录，运行 main 方法的时候用下面这个 projectPath
//        String projectPath = System.getProperty("user.dir") + File.separator + "code-generator-platform-maker";
        // 测试的时候用下面这个目录
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir");
        String originProjectPath = new File(projectPath) + File.separator + "code-generator-platform-samples/springboot-init";
