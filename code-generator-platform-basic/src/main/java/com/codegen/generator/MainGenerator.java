...
import com.codegen.model.MainTemplateConfig;
...
public class MainGenerator {
    ...
    public static void doGenerate(Object model) throws TemplateException, IOException {
        ...
        // 生成动态文件
        String inputDynamicFilePath = projectPath + File.separator + "code-generator-platform-basic" + File.separator + "src/main/resources/templates/MainTemplate.java.ftl";
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        ...
        mainTemplateConfig.setAuthor("mark.zeng");
